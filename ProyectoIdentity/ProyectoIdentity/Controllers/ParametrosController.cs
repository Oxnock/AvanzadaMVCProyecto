...
namespace ProyectoIdentity.Controllers
{
    public class ParametrosController : Controller
    {
        ...
        public ParametrosController(ProyectoIdentityContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var parametros = await _context.Parametros
                .SingleOrDefaultAsync(m => m.ParametrosId == id);
            if (parametros == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var parametros = await _context.Parametros.SingleOrDefaultAsync(m => m.ParametrosId == id);
            if (parametros == null)
            {
                return NotFound();
            }
