...
namespace ProyectoIdentity.Controllers
{
    public class PermisoesController : Controller
    {
        ...
        public PermisoesController(ProyectoIdentityContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var permiso = await _context.Permiso
                .SingleOrDefaultAsync(m => m.PermisoId == id);
            if (permiso == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var permiso = await _context.Permiso.SingleOrDefaultAsync(m => m.PermisoId == id);
            if (permiso == null)
            {
                return NotFound();
            }
