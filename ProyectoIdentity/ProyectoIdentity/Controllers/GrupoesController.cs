...
namespace ProyectoIdentity.Controllers
{
    public class GrupoesController : Controller
    {
        ...
        public GrupoesController(ProyectoIdentityContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var grupo = await _context.Grupo
                .SingleOrDefaultAsync(m => m.GrupoId == id);
            if (grupo == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var grupo = await _context.Grupo.SingleOrDefaultAsync(m => m.GrupoId == id);
            if (grupo == null)
            {
                return NotFound();
            }
