...
namespace ProyectoIdentity.Controllers
{
    public class AsistenciasController : Controller
    {
        ...
        public AsistenciasController(ProyectoIdentityContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var asistencia = await _context.Asistencia
                .SingleOrDefaultAsync(m => m.AsistenciaId == id);
            if (asistencia == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var asistencia = await _context.Asistencia.SingleOrDefaultAsync(m => m.AsistenciaId == id);
            if (asistencia == null)
            {
                return NotFound();
            }
