...
namespace ProyectoIdentity.Controllers
{
    public class MateriasController : Controller
    {
        ...
        public MateriasController(ProyectoIdentityContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var materia = await _context.Materia
                .SingleOrDefaultAsync(m => m.MateriaId == id);
            if (materia == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var materia = await _context.Materia.SingleOrDefaultAsync(m => m.MateriaId == id);
            if (materia == null)
            {
                return NotFound();
            }
