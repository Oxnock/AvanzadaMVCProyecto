...
namespace ProyectoIdentity.Controllers
{
    public class TipoUsuariosController : Controller
    {
        ...
        public TipoUsuariosController(ProyectoIdentityContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var tipoUsuario = await _context.TipoUsuario
                .SingleOrDefaultAsync(m => m.TipoUsuarioId == id);
            if (tipoUsuario == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var tipoUsuario = await _context.TipoUsuario.SingleOrDefaultAsync(m => m.TipoUsuarioId == id);
            if (tipoUsuario == null)
            {
                return NotFound();
            }
